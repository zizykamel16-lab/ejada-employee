...
public class employeesDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        employeesGlobalFeatureConfigurator.Configure();
        employeesModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<employeesDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<employeesResource>("ar")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/employees");

            options.DefaultResourceType = typeof(employeesResource);
        ...
        {
            options.MapCodeNamespace("employees", typeof(employeesResource));
        });
    }
}
